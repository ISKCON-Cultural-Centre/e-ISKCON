...
@Component({
  selector: 'app-devotee-list',
  templateUrl: './devotee-list.component.html',
  styleUrls: ['./devotee-list.component.css']
})
export class DevoteeListComponent implements OnInit {
